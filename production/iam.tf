...
resource "aws_iam_role" "lambda_cloudwatch" {
  name               = "${local.project}-${local.env}-iam-lambda-cloudwatch-logs-error-alert-role"
  path               = "/"
...
resource "aws_iam_policy" "lambda_cloudwatch" {
  name   = "${local.project}-${local.env}-iam-lambda-cloudwatch-logs-error-alert-policy"
...
resource "aws_iam_policy_attachment" "lambda" {
  name = "${local.project}-${local.env}-iam-lambda-cloudwatch-logs-error-alert-attachment"
  roles = [
